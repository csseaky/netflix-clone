...
export const Navbar = () => {
  ...
  return (
    <nav className="flex flex-row justify-around absolute top-5 z-10 w-full">
      ...
      <div className="flex gap-7 mr-20 items-start mt-2">
        <div
          className="flex gap-1 text-sm border-white justify-end items-center py-2 rounded-sm"
          style={{ borderWidth: 1 }}
        >
          <GlobeIcon />
          <select
        ...
        <button className="bg-red-600 px-5 py-2 text-white rounded-sm self-start">
          Sign In
        </button>
      </div>
    </nav>
...
const NetflixIcon = () => {
  return (
    <svg
      viewBox="0 0 111 30"
      focusable="false"
      className="fill-current text-netflix mt-2"
